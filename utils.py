...
async def get_shortlink(chat_id, link):
    ...
    #method 2
        ...
        try:
            ...
            print(f"Shortened URL Response: {link}")  # Debugging
        except Exception as e:
            print(f"Shortzy failed: {e}")
                    ...
                    await bot.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                                ...
                                InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/THE_DS_OFFICIAL")
                                ]
                            ]
                        )
                    )
